...
namespace structures
{
	...
	Array<T>& Array<T>::operator=(const Array<T>& other)
	{
		if (this != &other)
		{
			if (size_ != other.size_) //musi sa rovnat velkost poli
				throw std::invalid_argument("Arrays sizes differ!");
			//vector_ = other.vector_; //presmeruje pointer a vznika memory leak! 2 polia zdielaju spolocny vektor, kazde pole ma mat svoj vektor
			*vector_ = *(other.vector_); //priradujeme to naco smerniky ukazuju, dereferencujeme ich
		}
		return *this;
	}
	...
	{
		// skrateny zapis tej istej funkcie vyssie, bez lokalnych premennych
